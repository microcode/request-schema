...
class Schema {
    ...
    on(method, url, ...args) {
        ...
        data.add_entry(new Entry(filters, func), [this._options.dataParameter, this._options.contextParameter]);
    }
    ...
    async run(method, url, data, context) {
        ...
        capture.set(this._options.dataParameter, data);
        capture.set(this._options.contextParameter, context);
